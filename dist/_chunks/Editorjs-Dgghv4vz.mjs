...
import "react-dom";
import { P as PLUGIN_ID, R as RESOLVE_CONFIG } from "./index-CJSWGExv.mjs";
...
let EditorjsFieldNew = ({
  ...
  return /* @__PURE__ */ jsxs(EdWrap, { children: [
    /* @__PURE__ */ jsx(SEditor, { ref: editorContainerRef }),
    /* @__PURE__ */ jsx(
      MediaLibComponent,
      {
      ...
      SStyleWrapper,
      {
        ...
        children: /* @__PURE__ */ jsx(
          Field.Root,
          {
            ...
            error,
            children: config && !isLoading ? /* @__PURE__ */ jsxs(Flex, { spacing: 1, children: [
              /* @__PURE__ */ jsx(
                Field.Label,
                {
                  action: labelAction,
...
//# sourceMappingURL=Editorjs-Dgghv4vz.mjs.map
