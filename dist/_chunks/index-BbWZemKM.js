...
const configReducer = fn((state = initialState, action) => {
  switch (action.type) {
    case RESOLVE_CONFIG: {
...
const index = {
  register(app) {
    ...
    app.customFields.register({
      name: "PCOEditorjs",
      pluginId: "editorjs-strapi-plugin",
      type: "richtext",
      icon: PluginIcon,
      intlLabel: {
      ...
      components: {
        Input: async () => Promise.resolve().then(() => require("./Editorjs-By5P58WH.js")).then((module2) => ({
...
exports.index = index;
//# sourceMappingURL=index-BbWZemKM.js.map
